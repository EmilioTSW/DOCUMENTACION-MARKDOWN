...
Este documento desarrolla paso a paso la resolución de sistemas lineales mediante eliminación de Gauss, Gauss–Jordan, matriz inversa y regla de Cramer, además de la clasificación de sistemas según sus soluciones.
---

## Ejercicio 1. Sistema (3x3) distintos métodos
...
Se compararon distintos métodos de resolución de sistemas lineales, mostrando que todos convergen a las mismas soluciones cuando el sistema es compatible..
